...
class ProtoScalableMacro(val c: whitebox.Context) {
  ...
  class ToProtoProcessor(scalaTree: Tree, override val scalaTreeType: Type, override val caseClassType: Type,
                         override val protoType: Type, override val protoFieldName: String) extends ProtoFieldAnalyst {
  ...
  case class ToScalaFieldProcessor(accessor: MethodSymbol, override val caseClassType: Type, override val protoType: Type)
    extends AbstractToScalaProcessor with ProtoFieldAnalyst {
